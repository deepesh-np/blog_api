...
export default function NotFound() {
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-linear-to-br from-black via-gray-900 to-gray-800 overflow-hidden">
      ...
      <div className="relative z-10 max-w-lg w-full mx-4 p-10 rounded-3xl 
        ...
        <h1 className="text-7xl font-extrabold bg-linear-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
          404
        </h1>
        ...
        <div className="mt-8 flex justify-center gap-4">
          <Link
            to="/"
            className="px-6 py-3 rounded-xl bg-linear-to-r from-purple-500 to-cyan-500
